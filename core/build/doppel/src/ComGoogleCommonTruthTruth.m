...
@interface ComGoogleCommonTruthTruth_$1 : ComGoogleCommonTruthFailureStrategy
...
J2OBJC_EMPTY_STATIC_INIT(ComGoogleCommonTruthTruth_$1)

__attribute__((unused)) static void ComGoogleCommonTruthTruth_$1_init(ComGoogleCommonTruthTruth_$1 *self);

__attribute__((unused)) static ComGoogleCommonTruthTruth_$1 *new_ComGoogleCommonTruthTruth_$1_init() NS_RETURNS_RETAINED;

__attribute__((unused)) static ComGoogleCommonTruthTruth_$1 *create_ComGoogleCommonTruthTruth_$1_init();
...
+ (void)initialize {
  if (self == [ComGoogleCommonTruthTruth class]) {
    JreStrongAssignAndConsume(&ComGoogleCommonTruthTruth_THROW_ASSERTION_ERROR, new_ComGoogleCommonTruthTruth_$1_init());
...
@implementation ComGoogleCommonTruthTruth_$1
...
J2OBJC_IGNORE_DESIGNATED_BEGIN
- (instancetype)init {
  ComGoogleCommonTruthTruth_$1_init(self);
  return self;
}
J2OBJC_IGNORE_DESIGNATED_END
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  #pragma clang diagnostic push
  #pragma clang diagnostic ignored "-Wobjc-multiple-method-names"
  methods[0].selector = @selector(failComparingWithNSString:withJavaLangCharSequence:withJavaLangCharSequence:);
  ...
  static const J2ObjcClassInfo _ComGoogleCommonTruthTruth_$1 = { "", "com.google.common.truth", ptrTable, methods, NULL, 7, 0x8008, 2, 0, 2, -1, -1, -1, -1 };
  return &_ComGoogleCommonTruthTruth_$1;
}

@end

void ComGoogleCommonTruthTruth_$1_init(ComGoogleCommonTruthTruth_$1 *self) {
  ComGoogleCommonTruthFailureStrategy_init(self);
}

ComGoogleCommonTruthTruth_$1 *new_ComGoogleCommonTruthTruth_$1_init() {
  J2OBJC_NEW_IMPL(ComGoogleCommonTruthTruth_$1, init)
}

ComGoogleCommonTruthTruth_$1 *create_ComGoogleCommonTruthTruth_$1_init() {
  J2OBJC_CREATE_IMPL(ComGoogleCommonTruthTruth_$1, init)
}
