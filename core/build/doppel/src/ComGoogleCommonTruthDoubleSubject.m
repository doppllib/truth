...
@interface ComGoogleCommonTruthDoubleSubject_$1 : ComGoogleCommonTruthDoubleSubject_TolerantDoubleComparison {
 @public
...
J2OBJC_EMPTY_STATIC_INIT(ComGoogleCommonTruthDoubleSubject_$1)

J2OBJC_FIELD_SETTER(ComGoogleCommonTruthDoubleSubject_$1, this$0_, ComGoogleCommonTruthDoubleSubject *)

__attribute__((unused)) static void ComGoogleCommonTruthDoubleSubject_$1_initWithComGoogleCommonTruthDoubleSubject_withDouble_(ComGoogleCommonTruthDoubleSubject_$1 *self, ComGoogleCommonTruthDoubleSubject *outer$, jdouble capture$0);

__attribute__((unused)) static ComGoogleCommonTruthDoubleSubject_$1 *new_ComGoogleCommonTruthDoubleSubject_$1_initWithComGoogleCommonTruthDoubleSubject_withDouble_(ComGoogleCommonTruthDoubleSubject *outer$, jdouble capture$0) NS_RETURNS_RETAINED;

__attribute__((unused)) static ComGoogleCommonTruthDoubleSubject_$1 *create_ComGoogleCommonTruthDoubleSubject_$1_initWithComGoogleCommonTruthDoubleSubject_withDouble_(ComGoogleCommonTruthDoubleSubject *outer$, jdouble capture$0);

@interface ComGoogleCommonTruthDoubleSubject_$2 : ComGoogleCommonTruthDoubleSubject_TolerantDoubleComparison {
 @public
  ComGoogleCommonTruthDoubleSubject *this$0_;
  jdouble val$tolerance_;
}
...
J2OBJC_EMPTY_STATIC_INIT(ComGoogleCommonTruthDoubleSubject_$2)

J2OBJC_FIELD_SETTER(ComGoogleCommonTruthDoubleSubject_$2, this$0_, ComGoogleCommonTruthDoubleSubject *)

__attribute__((unused)) static void ComGoogleCommonTruthDoubleSubject_$2_initWithComGoogleCommonTruthDoubleSubject_withDouble_(ComGoogleCommonTruthDoubleSubject_$2 *self, ComGoogleCommonTruthDoubleSubject *outer$, jdouble capture$0);

__attribute__((unused)) static ComGoogleCommonTruthDoubleSubject_$2 *new_ComGoogleCommonTruthDoubleSubject_$2_initWithComGoogleCommonTruthDoubleSubject_withDouble_(ComGoogleCommonTruthDoubleSubject *outer$, jdouble capture$0) NS_RETURNS_RETAINED;

__attribute__((unused)) static ComGoogleCommonTruthDoubleSubject_$2 *create_ComGoogleCommonTruthDoubleSubject_$2_initWithComGoogleCommonTruthDoubleSubject_withDouble_(ComGoogleCommonTruthDoubleSubject *outer$, jdouble capture$0);
...
- (ComGoogleCommonTruthDoubleSubject_TolerantDoubleComparison *)isWithinWithDouble:(jdouble)tolerance {
  return create_ComGoogleCommonTruthDoubleSubject_$1_initWithComGoogleCommonTruthDoubleSubject_withDouble_(self, tolerance);
}

- (ComGoogleCommonTruthDoubleSubject_TolerantDoubleComparison *)isNotWithinWithDouble:(jdouble)tolerance {
  return create_ComGoogleCommonTruthDoubleSubject_$2_initWithComGoogleCommonTruthDoubleSubject_withDouble_(self, tolerance);
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcFieldInfo fields[] = {
    { "NEG_ZERO_BITS", "J", .constantValue.asLong = 0, 0x1a, -1, 14, -1, -1 },
  };
  static const void *ptrTable[] = { "LComGoogleCommonTruthFailureStrategy;LJavaLangDouble;", (void *)&ComGoogleCommonTruthDoubleSubject__Annotations$0, "isWithin", "D", "isNotWithin", "isEqualTo", "LJavaLangDouble;", (void *)&ComGoogleCommonTruthDoubleSubject__Annotations$1, "isNotEqualTo", (void *)&ComGoogleCommonTruthDoubleSubject__Annotations$2, "isEquivalentAccordingToCompareTo", "(Ljava/lang/Double;)V", (void *)&ComGoogleCommonTruthDoubleSubject__Annotations$3, "checkTolerance", &ComGoogleCommonTruthDoubleSubject_NEG_ZERO_BITS, "LComGoogleCommonTruthDoubleSubject_TolerantDoubleComparison;", "Lcom/google/common/truth/ComparableSubject<Lcom/google/common/truth/DoubleSubject;Ljava/lang/Double;>;" };
  static const J2ObjcClassInfo _ComGoogleCommonTruthDoubleSubject = { "DoubleSubject", "com.google.common.truth", ptrTable, methods, fields, 7, 0x11, 14, 1, -1, 15, -1, 16, -1 };
...
@implementation ComGoogleCommonTruthDoubleSubject_$1
...
- (instancetype)initWithComGoogleCommonTruthDoubleSubject:(ComGoogleCommonTruthDoubleSubject *)outer$
                                               withDouble:(jdouble)capture$0 {
  ComGoogleCommonTruthDoubleSubject_$1_initWithComGoogleCommonTruthDoubleSubject_withDouble_(self, outer$, capture$0);
  return self;
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  #pragma clang diagnostic push
  #pragma clang diagnostic ignored "-Wobjc-multiple-method-names"
  methods[0].selector = @selector(ofWithDouble:);
  methods[1].selector = @selector(initWithComGoogleCommonTruthDoubleSubject:withDouble:);
  #pragma clang diagnostic pop
  static const J2ObjcFieldInfo fields[] = {
  ...
  static const void *ptrTable[] = { "of", "D", "LComGoogleCommonTruthDoubleSubject;D", "LComGoogleCommonTruthDoubleSubject;", "isWithinWithDouble:" };
  static const J2ObjcClassInfo _ComGoogleCommonTruthDoubleSubject_$1 = { "", "com.google.common.truth", ptrTable, methods, fields, 7, 0x8008, 2, 2, 3, -1, 4, -1, -1 };
  return &_ComGoogleCommonTruthDoubleSubject_$1;
}

@end

void ComGoogleCommonTruthDoubleSubject_$1_initWithComGoogleCommonTruthDoubleSubject_withDouble_(ComGoogleCommonTruthDoubleSubject_$1 *self, ComGoogleCommonTruthDoubleSubject *outer$, jdouble capture$0) {
  JreStrongAssign(&self->this$0_, outer$);
  self->val$tolerance_ = capture$0;
  ComGoogleCommonTruthDoubleSubject_TolerantDoubleComparison_init(self);
}

ComGoogleCommonTruthDoubleSubject_$1 *new_ComGoogleCommonTruthDoubleSubject_$1_initWithComGoogleCommonTruthDoubleSubject_withDouble_(ComGoogleCommonTruthDoubleSubject *outer$, jdouble capture$0) {
  J2OBJC_NEW_IMPL(ComGoogleCommonTruthDoubleSubject_$1, initWithComGoogleCommonTruthDoubleSubject_withDouble_, outer$, capture$0)
}

ComGoogleCommonTruthDoubleSubject_$1 *create_ComGoogleCommonTruthDoubleSubject_$1_initWithComGoogleCommonTruthDoubleSubject_withDouble_(ComGoogleCommonTruthDoubleSubject *outer$, jdouble capture$0) {
  J2OBJC_CREATE_IMPL(ComGoogleCommonTruthDoubleSubject_$1, initWithComGoogleCommonTruthDoubleSubject_withDouble_, outer$, capture$0)
}

@implementation ComGoogleCommonTruthDoubleSubject_$2
...
- (instancetype)initWithComGoogleCommonTruthDoubleSubject:(ComGoogleCommonTruthDoubleSubject *)outer$
                                               withDouble:(jdouble)capture$0 {
  ComGoogleCommonTruthDoubleSubject_$2_initWithComGoogleCommonTruthDoubleSubject_withDouble_(self, outer$, capture$0);
  return self;
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { "of", "D", "LComGoogleCommonTruthDoubleSubject;D", "LComGoogleCommonTruthDoubleSubject;", "isNotWithinWithDouble:" };
  static const J2ObjcClassInfo _ComGoogleCommonTruthDoubleSubject_$2 = { "", "com.google.common.truth", ptrTable, methods, fields, 7, 0x8008, 2, 2, 3, -1, 4, -1, -1 };
  return &_ComGoogleCommonTruthDoubleSubject_$2;
}

@end

void ComGoogleCommonTruthDoubleSubject_$2_initWithComGoogleCommonTruthDoubleSubject_withDouble_(ComGoogleCommonTruthDoubleSubject_$2 *self, ComGoogleCommonTruthDoubleSubject *outer$, jdouble capture$0) {
  JreStrongAssign(&self->this$0_, outer$);
  self->val$tolerance_ = capture$0;
  ComGoogleCommonTruthDoubleSubject_TolerantDoubleComparison_init(self);
}

ComGoogleCommonTruthDoubleSubject_$2 *new_ComGoogleCommonTruthDoubleSubject_$2_initWithComGoogleCommonTruthDoubleSubject_withDouble_(ComGoogleCommonTruthDoubleSubject *outer$, jdouble capture$0) {
  J2OBJC_NEW_IMPL(ComGoogleCommonTruthDoubleSubject_$2, initWithComGoogleCommonTruthDoubleSubject_withDouble_, outer$, capture$0)
}

ComGoogleCommonTruthDoubleSubject_$2 *create_ComGoogleCommonTruthDoubleSubject_$2_initWithComGoogleCommonTruthDoubleSubject_withDouble_(ComGoogleCommonTruthDoubleSubject *outer$, jdouble capture$0) {
  J2OBJC_CREATE_IMPL(ComGoogleCommonTruthDoubleSubject_$2, initWithComGoogleCommonTruthDoubleSubject_withDouble_, outer$, capture$0)
}
