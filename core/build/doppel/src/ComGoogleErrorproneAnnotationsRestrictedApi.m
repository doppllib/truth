...
//  source: /Users/kgalligan/devel-doppl/truth/core/src/main/java/com/google/errorprone/annotations/RestrictedApi.java
//
...
IOSObjectArray *ComGoogleErrorproneAnnotationsRestrictedApi__Annotations$0() {
  return [IOSObjectArray arrayWithObjects:(id[]){ create_JavaLangAnnotationTarget([IOSObjectArray arrayWithObjects:(id[]){ JreLoadEnum(JavaLangAnnotationElementType, CONSTRUCTOR), JreLoadEnum(JavaLangAnnotationElementType, METHOD) } count:2 type:NSObject_class_()]) } count:1 type:JavaLangAnnotationAnnotation_class_()];
}
