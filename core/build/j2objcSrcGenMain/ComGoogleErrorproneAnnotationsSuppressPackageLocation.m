...
//  source: /Users/kgalligan/devel-doppl/truth/core/src/main/java/com/google/errorprone/annotations/SuppressPackageLocation.java
//
...
IOSObjectArray *ComGoogleErrorproneAnnotationsSuppressPackageLocation__Annotations$0() {
  return [IOSObjectArray arrayWithObjects:(id[]){ create_JavaLangAnnotationTarget([IOSObjectArray arrayWithObjects:(id[]){ JreLoadEnum(JavaLangAnnotationElementType, PACKAGE) } count:1 type:NSObject_class_()]), create_JavaLangAnnotationRetention(JreLoadEnum(JavaLangAnnotationRetentionPolicy, CLASS)) } count:2 type:JavaLangAnnotationAnnotation_class_()];
}
