...
//  source: build/dopplJavaMain/com/google/common/truth/MultimapSubject.java
//
...
__attribute__((unused)) static IOSObjectArray *ComGoogleCommonTruthMultimapSubject__Annotations$0(void);

__attribute__((unused)) static IOSObjectArray *ComGoogleCommonTruthMultimapSubject__Annotations$1(void);

__attribute__((unused)) static IOSObjectArray *ComGoogleCommonTruthMultimapSubject__Annotations$2(void);

__attribute__((unused)) static IOSObjectArray *ComGoogleCommonTruthMultimapSubject__Annotations$3(void);

__attribute__((unused)) static IOSObjectArray *ComGoogleCommonTruthMultimapSubject__Annotations$4(void);

__attribute__((unused)) static IOSObjectArray *ComGoogleCommonTruthMultimapSubject__Annotations$5(void);

__attribute__((unused)) static IOSObjectArray *ComGoogleCommonTruthMultimapSubject__Annotations$6(void);

__attribute__((unused)) static IOSObjectArray *ComGoogleCommonTruthMultimapSubject__Annotations$7(void);

__attribute__((unused)) static IOSObjectArray *ComGoogleCommonTruthMultimapSubject__Annotations$8(void);
...
__attribute__((unused)) static IOSObjectArray *ComGoogleCommonTruthMultimapSubject_IterableValuesForKey__Annotations$0(void);

__attribute__((unused)) static IOSObjectArray *ComGoogleCommonTruthMultimapSubject_IterableValuesForKey__Annotations$1(void);

__attribute__((unused)) static IOSObjectArray *ComGoogleCommonTruthMultimapSubject_IterableValuesForKey__Annotations$2(void);
...
__attribute__((unused)) static id<ComGoogleCommonTruthOrdered> ComGoogleCommonTruthMultimapSubject_UsingCorrespondence_containsExactlyEntriesInWithComGoogleCommonCollectMultimap_(ComGoogleCommonTruthMultimapSubject_UsingCorrespondence *self, id<ComGoogleCommonCollectMultimap> expectedMultimap);

__attribute__((unused)) static ComGoogleCommonTruthIterableSubject_UsingCorrespondence *ComGoogleCommonTruthMultimapSubject_UsingCorrespondence_valuesForKeyWithId_(ComGoogleCommonTruthMultimapSubject_UsingCorrespondence *self, id key);
...
__attribute__((unused)) static IOSObjectArray *ComGoogleCommonTruthMultimapSubject_UsingCorrespondence__Annotations$0(void);

__attribute__((unused)) static IOSObjectArray *ComGoogleCommonTruthMultimapSubject_UsingCorrespondence__Annotations$1(void);

__attribute__((unused)) static IOSObjectArray *ComGoogleCommonTruthMultimapSubject_UsingCorrespondence__Annotations$2(void);
...
- (id<ComGoogleCommonTruthOrdered>)containsExactlyEntriesInWithComGoogleCommonCollectMultimap:(id<ComGoogleCommonCollectMultimap> __nonnull)expectedMultimap {
  return ComGoogleCommonTruthMultimapSubject_UsingCorrespondence_containsExactlyEntriesInWithComGoogleCommonCollectMultimap_(self, expectedMultimap);
}

- (ComGoogleCommonTruthIterableSubject_UsingCorrespondence *)valuesForKeyWithId:(id __nullable)key {
  return ComGoogleCommonTruthMultimapSubject_UsingCorrespondence_valuesForKeyWithId_(self, key);
}
...
id<ComGoogleCommonTruthOrdered> ComGoogleCommonTruthMultimapSubject_UsingCorrespondence_containsExactlyEntriesInWithComGoogleCommonCollectMultimap_(ComGoogleCommonTruthMultimapSubject_UsingCorrespondence *self, id<ComGoogleCommonCollectMultimap> expectedMultimap) {
  @throw create_JavaLangUnsupportedOperationException_init();
}

ComGoogleCommonTruthIterableSubject_UsingCorrespondence *ComGoogleCommonTruthMultimapSubject_UsingCorrespondence_valuesForKeyWithId_(ComGoogleCommonTruthMultimapSubject_UsingCorrespondence *self, id key) {
  @throw create_JavaLangUnsupportedOperationException_init();
}
