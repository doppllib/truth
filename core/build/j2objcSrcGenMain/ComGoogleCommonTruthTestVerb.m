...
#include "ComGoogleCommonCollectTable.h"
...
@interface ComGoogleCommonTruthTestVerb_$1 : ComGoogleCommonTruthComparableSubject

- (instancetype)initWithComGoogleCommonTruthFailureStrategy:(ComGoogleCommonTruthFailureStrategy *)arg$0
                                     withJavaLangComparable:(id<JavaLangComparable>)arg$1;

@end

J2OBJC_EMPTY_STATIC_INIT(ComGoogleCommonTruthTestVerb_$1)

__attribute__((unused)) static void ComGoogleCommonTruthTestVerb_$1_initWithComGoogleCommonTruthFailureStrategy_withJavaLangComparable_(ComGoogleCommonTruthTestVerb_$1 *self, ComGoogleCommonTruthFailureStrategy *arg$0, id<JavaLangComparable> arg$1);

__attribute__((unused)) static ComGoogleCommonTruthTestVerb_$1 *new_ComGoogleCommonTruthTestVerb_$1_initWithComGoogleCommonTruthFailureStrategy_withJavaLangComparable_(ComGoogleCommonTruthFailureStrategy *arg$0, id<JavaLangComparable> arg$1) NS_RETURNS_RETAINED;

__attribute__((unused)) static ComGoogleCommonTruthTestVerb_$1 *create_ComGoogleCommonTruthTestVerb_$1_initWithComGoogleCommonTruthFailureStrategy_withJavaLangComparable_(ComGoogleCommonTruthFailureStrategy *arg$0, id<JavaLangComparable> arg$1);
...
- (ComGoogleCommonTruthComparableSubject *)thatWithJavaLangComparable:(id<JavaLangComparable>)target {
  return create_ComGoogleCommonTruthTestVerb_$1_initWithComGoogleCommonTruthFailureStrategy_withJavaLangComparable_([self getFailureStrategy], target);
}
...
+ (const J2ObjcClassInfo *)__metadata {
  static J2ObjcMethodInfo methods[] = {
    ...
    { NULL, "LComGoogleCommonTruthTestVerb;", 0x1, 83, 29, -1, 84, -1, 85 },
    { NULL, "LComGoogleCommonTruthTestVerb;", 0x81, 83, 86, -1, 87, -1, 88 },
  };
...
@implementation ComGoogleCommonTruthTestVerb_$1

- (instancetype)initWithComGoogleCommonTruthFailureStrategy:(ComGoogleCommonTruthFailureStrategy *)arg$0
                                     withJavaLangComparable:(id<JavaLangComparable>)arg$1 {
  ComGoogleCommonTruthTestVerb_$1_initWithComGoogleCommonTruthFailureStrategy_withJavaLangComparable_(self, arg$0, arg$1);
  return self;
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _ComGoogleCommonTruthTestVerb_$1 = { "", "com.google.common.truth", ptrTable, methods, NULL, 7, 0x8008, 1, 0, 1, -1, 2, -1, -1 };
  return &_ComGoogleCommonTruthTestVerb_$1;
}

@end

void ComGoogleCommonTruthTestVerb_$1_initWithComGoogleCommonTruthFailureStrategy_withJavaLangComparable_(ComGoogleCommonTruthTestVerb_$1 *self, ComGoogleCommonTruthFailureStrategy *arg$0, id<JavaLangComparable> arg$1) {
  ComGoogleCommonTruthComparableSubject_initWithComGoogleCommonTruthFailureStrategy_withJavaLangComparable_(self, arg$0, arg$1);
}

ComGoogleCommonTruthTestVerb_$1 *new_ComGoogleCommonTruthTestVerb_$1_initWithComGoogleCommonTruthFailureStrategy_withJavaLangComparable_(ComGoogleCommonTruthFailureStrategy *arg$0, id<JavaLangComparable> arg$1) {
  J2OBJC_NEW_IMPL(ComGoogleCommonTruthTestVerb_$1, initWithComGoogleCommonTruthFailureStrategy_withJavaLangComparable_, arg$0, arg$1)
}

ComGoogleCommonTruthTestVerb_$1 *create_ComGoogleCommonTruthTestVerb_$1_initWithComGoogleCommonTruthFailureStrategy_withJavaLangComparable_(ComGoogleCommonTruthFailureStrategy *arg$0, id<JavaLangComparable> arg$1) {
  J2OBJC_CREATE_IMPL(ComGoogleCommonTruthTestVerb_$1, initWithComGoogleCommonTruthFailureStrategy_withJavaLangComparable_, arg$0, arg$1)
}
