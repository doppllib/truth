...
//  source: build/dopplJavaMain/com/google/errorprone/annotations/DoNotMock.java
//
...
__attribute__((unused)) static IOSObjectArray *ComGoogleErrorproneAnnotationsDoNotMock__Annotations$0(void);
...
- (jboolean)isEqual:(id)obj {
  return [obj isKindOfClass:[ComGoogleErrorproneAnnotationsDoNotMock class]] && [value_ isEqual:((ComGoogleErrorproneAnnotationsDoNotMock*)obj)->value_];
}
