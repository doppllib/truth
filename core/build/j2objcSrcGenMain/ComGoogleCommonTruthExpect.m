...
//  source: /Users/kgalligan/devel-doppl/truth/core/src/main/java/com/google/common/truth/Expect.java
//
...
@interface ComGoogleCommonTruthExpect_$1 : OrgJunitRunnersModelStatement {
 @public
...
J2OBJC_EMPTY_STATIC_INIT(ComGoogleCommonTruthExpect_$1)

J2OBJC_FIELD_SETTER(ComGoogleCommonTruthExpect_$1, this$0_, ComGoogleCommonTruthExpect *)
J2OBJC_FIELD_SETTER(ComGoogleCommonTruthExpect_$1, val$base_, OrgJunitRunnersModelStatement *)

__attribute__((unused)) static void ComGoogleCommonTruthExpect_$1_initWithComGoogleCommonTruthExpect_withOrgJunitRunnersModelStatement_(ComGoogleCommonTruthExpect_$1 *self, ComGoogleCommonTruthExpect *outer$, OrgJunitRunnersModelStatement *capture$0);

__attribute__((unused)) static ComGoogleCommonTruthExpect_$1 *new_ComGoogleCommonTruthExpect_$1_initWithComGoogleCommonTruthExpect_withOrgJunitRunnersModelStatement_(ComGoogleCommonTruthExpect *outer$, OrgJunitRunnersModelStatement *capture$0) NS_RETURNS_RETAINED;

__attribute__((unused)) static ComGoogleCommonTruthExpect_$1 *create_ComGoogleCommonTruthExpect_$1_initWithComGoogleCommonTruthExpect_withOrgJunitRunnersModelStatement_(ComGoogleCommonTruthExpect *outer$, OrgJunitRunnersModelStatement *capture$0);
...
- (OrgJunitRunnersModelStatement *)applyWithOrgJunitRunnersModelStatement:(OrgJunitRunnersModelStatement *)base
  ...
  return create_ComGoogleCommonTruthExpect_$1_initWithComGoogleCommonTruthExpect_withOrgJunitRunnersModelStatement_(self, base);
}
...
@implementation ComGoogleCommonTruthExpect_$1
...
- (instancetype)initWithComGoogleCommonTruthExpect:(ComGoogleCommonTruthExpect *)outer$
                 withOrgJunitRunnersModelStatement:(OrgJunitRunnersModelStatement *)capture$0 {
  ComGoogleCommonTruthExpect_$1_initWithComGoogleCommonTruthExpect_withOrgJunitRunnersModelStatement_(self, outer$, capture$0);
  return self;
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  #pragma clang diagnostic push
  #pragma clang diagnostic ignored "-Wobjc-multiple-method-names"
  methods[0].selector = @selector(evaluate);
  methods[1].selector = @selector(initWithComGoogleCommonTruthExpect:withOrgJunitRunnersModelStatement:);
  #pragma clang diagnostic pop
  static const J2ObjcFieldInfo fields[] = {
  ...
  static const void *ptrTable[] = { "LNSException;", "LComGoogleCommonTruthExpect;LOrgJunitRunnersModelStatement;", "LComGoogleCommonTruthExpect;", "applyWithOrgJunitRunnersModelStatement:withOrgJunitRunnerDescription:" };
  static const J2ObjcClassInfo _ComGoogleCommonTruthExpect_$1 = { "", "com.google.common.truth", ptrTable, methods, fields, 7, 0x8008, 2, 2, 2, -1, 3, -1, -1 };
  return &_ComGoogleCommonTruthExpect_$1;
}

@end

void ComGoogleCommonTruthExpect_$1_initWithComGoogleCommonTruthExpect_withOrgJunitRunnersModelStatement_(ComGoogleCommonTruthExpect_$1 *self, ComGoogleCommonTruthExpect *outer$, OrgJunitRunnersModelStatement *capture$0) {
  JreStrongAssign(&self->this$0_, outer$);
  JreStrongAssign(&self->val$base_, capture$0);
  OrgJunitRunnersModelStatement_init(self);
}

ComGoogleCommonTruthExpect_$1 *new_ComGoogleCommonTruthExpect_$1_initWithComGoogleCommonTruthExpect_withOrgJunitRunnersModelStatement_(ComGoogleCommonTruthExpect *outer$, OrgJunitRunnersModelStatement *capture$0) {
  J2OBJC_NEW_IMPL(ComGoogleCommonTruthExpect_$1, initWithComGoogleCommonTruthExpect_withOrgJunitRunnersModelStatement_, outer$, capture$0)
}

ComGoogleCommonTruthExpect_$1 *create_ComGoogleCommonTruthExpect_$1_initWithComGoogleCommonTruthExpect_withOrgJunitRunnersModelStatement_(ComGoogleCommonTruthExpect *outer$, OrgJunitRunnersModelStatement *capture$0) {
  J2OBJC_CREATE_IMPL(ComGoogleCommonTruthExpect_$1, initWithComGoogleCommonTruthExpect_withOrgJunitRunnersModelStatement_, outer$, capture$0)
}
