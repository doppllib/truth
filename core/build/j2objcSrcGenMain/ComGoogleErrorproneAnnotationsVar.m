...
//  source: build/dopplJavaMain/com/google/errorprone/annotations/Var.java
//
...
__attribute__((unused)) static IOSObjectArray *ComGoogleErrorproneAnnotationsVar__Annotations$0(void);
...
- (jboolean)isEqual:(id)obj {
  return [obj isKindOfClass:[ComGoogleErrorproneAnnotationsVar class]];
}
