...
FOUNDATION_EXPORT ComGoogleCommonTruthExpect *ComGoogleCommonTruthExpect_createAndEnableStackTrace(void);
...
FOUNDATION_EXPORT ComGoogleCommonTruthExpect_ExpectationGatherer *new_ComGoogleCommonTruthExpect_ExpectationGatherer_init(void) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT ComGoogleCommonTruthExpect_ExpectationGatherer *create_ComGoogleCommonTruthExpect_ExpectationGatherer_init(void);
