...
//  source: build/dopplJavaMain/com/google/common/truth/PrimitiveDoubleArraySubject.java
//
...
inline ComGoogleCommonTruthCorrespondence *ComGoogleCommonTruthPrimitiveDoubleArraySubject_get_EXACT_EQUALITY_CORRESPONDENCE(void);
...
__attribute__((unused)) static IOSObjectArray *ComGoogleCommonTruthPrimitiveDoubleArraySubject__Annotations$0(void);

__attribute__((unused)) static IOSObjectArray *ComGoogleCommonTruthPrimitiveDoubleArraySubject__Annotations$1(void);

__attribute__((unused)) static IOSObjectArray *ComGoogleCommonTruthPrimitiveDoubleArraySubject__Annotations$2(void);

__attribute__((unused)) static IOSObjectArray *ComGoogleCommonTruthPrimitiveDoubleArraySubject__Annotations$3(void);

__attribute__((unused)) static IOSObjectArray *ComGoogleCommonTruthPrimitiveDoubleArraySubject__Annotations$4(void);

__attribute__((unused)) static IOSObjectArray *ComGoogleCommonTruthPrimitiveDoubleArraySubject__Annotations$5(void);
...
__attribute__((unused)) static IOSObjectArray *ComGoogleCommonTruthPrimitiveDoubleArraySubject_TolerantPrimitiveDoubleArrayComparison__Annotations$0(void);

__attribute__((unused)) static IOSObjectArray *ComGoogleCommonTruthPrimitiveDoubleArraySubject_TolerantPrimitiveDoubleArrayComparison__Annotations$1(void);

__attribute__((unused)) static IOSObjectArray *ComGoogleCommonTruthPrimitiveDoubleArraySubject_TolerantPrimitiveDoubleArrayComparison__Annotations$2(void);
...
__attribute__((unused)) static ComGoogleCommonTruthPrimitiveDoubleArraySubject_3 *new_ComGoogleCommonTruthPrimitiveDoubleArraySubject_3_init(void) NS_RETURNS_RETAINED;

__attribute__((unused)) static ComGoogleCommonTruthPrimitiveDoubleArraySubject_3 *create_ComGoogleCommonTruthPrimitiveDoubleArraySubject_3_init(void);
