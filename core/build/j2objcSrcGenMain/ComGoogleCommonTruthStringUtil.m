...
//  source: build/dopplJavaMain/com/google/common/truth/StringUtil.java
//
...
__attribute__((unused)) static ComGoogleCommonTruthStringUtil *new_ComGoogleCommonTruthStringUtil_init(void) NS_RETURNS_RETAINED;

__attribute__((unused)) static ComGoogleCommonTruthStringUtil *create_ComGoogleCommonTruthStringUtil_init(void);

__attribute__((unused)) static IOSObjectArray *ComGoogleCommonTruthStringUtil__Annotations$0(void);
