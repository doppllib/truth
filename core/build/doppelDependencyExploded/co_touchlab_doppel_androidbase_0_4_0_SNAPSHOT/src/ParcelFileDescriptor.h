...
#pragma push_macro("INCLUDE_ALL_ParcelFileDescriptor")
#ifdef RESTRICT_ParcelFileDescriptor
#define INCLUDE_ALL_ParcelFileDescriptor 0
#else
#define INCLUDE_ALL_ParcelFileDescriptor 1
#endif
#undef RESTRICT_ParcelFileDescriptor

#if !defined (AndroidOsParcelFileDescriptor_) && (INCLUDE_ALL_ParcelFileDescriptor || defined(INCLUDE_AndroidOsParcelFileDescriptor))
...
#if !defined (AndroidOsParcelFileDescriptor_AutoCloseInputStream_) && (INCLUDE_ALL_ParcelFileDescriptor || defined(INCLUDE_AndroidOsParcelFileDescriptor_AutoCloseInputStream))
...
#if !defined (AndroidOsParcelFileDescriptor_AutoCloseOutputStream_) && (INCLUDE_ALL_ParcelFileDescriptor || defined(INCLUDE_AndroidOsParcelFileDescriptor_AutoCloseOutputStream))
...
#pragma pop_macro("INCLUDE_ALL_ParcelFileDescriptor")
