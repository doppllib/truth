...
Pod::Spec.new do |s|
  ...
  TODO: Add long description of the pod here.
    ...
    s.source_files = FileList["build/doppllib.h"].include("build/dopplBuild/dependencies/out/main/**/*.{h,m,cpp,properites,txt}").include("build/dopplBuild/source/out/main/**/*.{h,m,cpp,properites,txt}").include("build/classes/main/**/*.java").include("build/generated/source/apt/main/**/*.java").include("src/main/java/**/*.java").include("build/dopplBuild/dependencies/exploded/doppl/co_doppl_junit_junit_4_12_0/java/**/*.java").include("build/dopplBuild/dependencies/exploded/doppl/co_doppl_org_hamcrest_hamcrest_core_1_3_0/java/**/*.java").to_ary
